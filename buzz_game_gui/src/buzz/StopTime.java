 ...
 * 
 */
public class StopTime extends javax.swing.JFrame implements Runnable {

    
        private int IDerotisis, IDapant, rounds = 0,p;
double k=0;
    boolean u1,u2,f=true;
    ...
    /**
     * Creates new form StopTime
     */
    public StopTime(Erotiseis E) throws IOException {
   ...
   for( rounds=0;rounds<4;rounds++){  
    ...
    while(k<=5000){
        ...
        this.Timer.setText("" +(5000-k)/1000+ " sec" );
         try {
             sleep(100);
         } catch (InterruptedException ex) {
             Logger.getLogger(StopTime.class.getName()).log(Level.SEVERE, null, ex);
         }
      ...
      public void EnableButtonsHotKeys()
    {
      ...
      private void Round() throws IOException {
        ...
        this.Print.setText(que);
            String t= e.getPhoto(IDerotisis);
        ...
        if( !(t.contains("no")) ){
            ...
            ImageIcon iic =new ImageIcon(getClass().getResource("/Buzz/images/"+t+".jpg"));
             jLabel3.setIcon(iic);
...
k=0;
    ...
    private void initComponents() {
        ...
        Print3 = new javax.swing.JScrollPane();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(Print3, javax.swing.GroupLayout.PREFERRED_SIZE, 364, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(352, 352, 352)
                        .addComponent(Timer, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel3)
                    .addComponent(Print3, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void Ap1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ap1ActionPerformed
        ...
        if(u1==true){
            ...
            if (epilogi.equals(apant)) {
                NewJFrame.pontoi = NewJFrame.pontoi + (5000-k)*0.2;
    ...
    private void Ap2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ap2ActionPerformed
        ...
        if(u2==true){
            ...
            this.Dp2.setEnabled(false);
            if (epilogi.equals(apant)) {
                NewJFrame.pontoi2 = NewJFrame.pontoi2 + (5000-k)*0.2;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StopTime.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JScrollPane Print3;
